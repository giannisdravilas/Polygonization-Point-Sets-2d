...
struct polygon_is_ok{
    Polygon_2 polygon;
    bool isOk;
};


polygon_is_ok local_search(Polygon_2 init_polygon, int L, bool max, double threshold, double max_time);
...
polygon_is_ok simulated_annealing_algorithm(string inputFile, string outputFile, bool maximization_problem, Polygon_2 startPolygon, int L, string annealing, Points pointsToIgnore, double max_time);
...
polygon_is_ok simulated_annealing_algorithm_subdivision(string inputFile, string outputFile, bool maximization_problem, int L, string annealing, int edgeSelection, string startAlgorithm, double max_time);
